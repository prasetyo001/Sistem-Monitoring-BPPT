                  ...
                  <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example" style="text-align: center">
                    ...
                    <tr>
                      <th colspan="4" align="center">
                        ...
                        <!-- <a class="btn btn-default navbar-right" data-toggle="modal" target="_blank" style="position: relative; margin-right: 10px;" href="<?php echo base_url().'index.php/c_excel/export_room8/' . $this->uri->segment(3);?>">
                          <i class="glyphicon glyphicon-print"></i> Export Excel</a>
                        <a class="btn btn-default navbar-right" data-toggle="modal" target="_blank" style="position: relative; margin-right: 10px;" href="<?php echo base_url().'index.php/claporanpdf/room8/'. $this->uri->segment(3);?>">
